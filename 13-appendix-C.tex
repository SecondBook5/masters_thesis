...
specimens. Cell-type reference transfer uses the Lung Cancer Atlas (LuCA, disease-aware, primary)
...
\todo{Confirm the GEO accession and platform for the LUAD \emph{spatial} arm; only the snRNA
accession (GSE308103) is verifiable from the pipeline configuration.}
...
The main text (Section~\ref{sec:ladder}) reports the load-bearing rungs of the falsification ladder.
