...
$\Pi^{(k)}$ that supervises training (Chapter~\ref{chap:methods}, Equation~\ref{eq:methods-entropic-coupling}), and as the
Sinkhorn distance that measures endpoint accuracy in the falsification ladder
(Section~\ref{sec:results-ladder}). This appendix defines the entropic transport problem and the log-domain
