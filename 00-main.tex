...
\DeclareMathOperator*{\argmin}{arg\,min} % argmin (starred: subscript sits below)
...
\include{frontmatter-abbreviations}         % List of Abbreviations (self-contained longtable)
%
...
%% Ch1 Introduction (06); Ch2 StageBridge: Materials and Methods (07);
%% Ch3 Results (08, \input drafts/results); Ch4 Discussion and Conclusions (09).
%% Filenames now match rendered chapter numbers.
...
\include{13-appendix-C}
%\include{14-appendix-D}
